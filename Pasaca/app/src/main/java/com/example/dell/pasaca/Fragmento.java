...
public class Fragmento extends Fragment {
    ...
    //COMPONENTES PARA TOMAR EL CONTROL
    EditText hora, precio;
    Button boton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_fragmento, container, false);
        //se toma el cntrol de los componentes
        boton = (Button) vista.findViewById(R.id.btnFragmento);
        hora = (EditText) vista.findViewById(R.id.txtFragmento1);
        precio = (EditText) vista.findViewById(R.id.txtFragmento2);
        boton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int horas=Integer.parseInt(hora.getText().toString());
                double preciohora = Double.parseDouble(precio.getText().toString());
                double sueldo;
                if (horas<=40){
                ...
                Toast.makeText(getContext(), "Sueldo Neto: "+sueldo,Toast.LENGTH_SHORT).show();
            }
        });
        return vista;
    }
